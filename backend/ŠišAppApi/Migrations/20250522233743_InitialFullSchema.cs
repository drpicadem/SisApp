        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceCategories_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalonAmenities_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SalonAmenities_Salons_SalonId",
                        column: x => x.SalonId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    Preferences = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FavoriteBarbers = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FavoriteSalons = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FavoriteServices = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LoyaltyPoints = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    RecommendedServiceId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommendations_Services_RecommendedServiceId",
                        column: x => x.RecommendedServiceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BarberSpecialties", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BarberSpecialties_Barbers_BarberId",
                        column: x => x.BarberId,
                        principalTable: "Barbers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BarberSpecialties_Services_ServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarberNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BarberSpecialties_BarberId",
                table: "BarberSpecialties",
                column: "BarberId");

            migrationBuilder.CreateIndex(
                name: "IX_BarberSpecialties_ServiceId",
                table: "BarberSpecialties",
                column: "ServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_RecommendedServiceId",
                table: "Recommendations",
                column: "RecommendedServiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalonAmenities_ImageId",
                table: "SalonAmenities",
                column: "ImageId");

            migrationBuilder.CreateIndex(
                name: "IX_SalonAmenities_SalonId",
                table: "SalonAmenities",
                column: "SalonId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceCategories_ImageId",
