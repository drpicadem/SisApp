...
namespace ŠišAppApi.Migrations
{
    ...
    [Migration("20260523163016_AddAppointmentAuditFieldsAndPaymentSession")]
    partial class AddAppointmentAuditFieldsAndPaymentSession
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ŠišAppApi.Models.PaymentSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ŠišAppApi.Models.AdminLog", b =>
                {
                    b.HasOne("ŠišAppApi.Models.Admin", "Admin")
                        .WithMany("AdminLogs")
            ...
            modelBuilder.Entity("ŠišAppApi.Models.Appointment", b =>
                {
                    ...
                    b.HasOne("ŠišAppApi.Models.User", "CancelledByUser")
                        .WithMany()
                        .HasForeignKey("CancelledByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ŠišAppApi.Models.User", "ConfirmedByUser")
                        .WithMany()
